...
public class TextilesOrderDetails  extends MainActivity
        implements NavigationView.OnNavigationItemSelectedListener,GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener,
        LocationListener {

    RelativeLayout relativeLayout,saveproduct,backfrag,submit,tempsave,varientclose;
    String MY_PREFS_NAME,User_ID;
    static String Session_ID;
    ArrayList <JSONObject>productlist;
    ArrayList<String> ordwsplist;
    ArrayList<String> ordmrplist;
    ArrayList<String> selectedproidlist,ordpronamelist,ordprocatglist,ordpromaincatglist,ordprodidlist,ordvarient,ordsize36,ordsize38,ordsize40,ordsize42,ordsize44,ordsize46,ordsizetype,ordqty,ordsleeve,ordcolor,ordcolimage,ordfit,ordleng;
    ...
    String size = "0",savestatus="false",viewstatus="gridview",tileproaddsta="",topbotstatus="",singleproaddsta="",multiproaddsta="",gridproaddsta="",gridmainprosta="",status ="",cusID,custname,odate,ddate,comment,dproid,dpname,dpcatge,dpwsp,dpmrp,sleevestatus;
    ...
    String cqtystatus="",minustatus="false",mainproductid,mainproductname,mainproductcatge,mainproductmaincatge,mainopenstatus,maincheckingstatus,mainsizebasecost;
    int mainpostions;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.dhotiorder_fragment, null, false);
        ...
        backfrag.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getBaseContext(),TextilesCustomerDetails.class);
        ...
        selectproduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog = new Dialog(TextilesOrderDetails.this,android.R.style.Theme_Light);
                ...
                mainviews.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        PopupMenu popup = new PopupMenu(TextilesOrderDetails.this, mainviews);
    ...
    public void openfilterbox(){
        ...
        brandvalue = "";
        catgevalue = "";
        final Dialog filterdialog = new Dialog(TextilesOrderDetails.this);
        ...
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<>(TextilesOrderDetails.this, android.R.layout.simple_spinner_item, catgefilterlist);
        ...
        ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<>(TextilesOrderDetails.this, android.R.layout.simple_spinner_item, brandfilterlist);
    ...
    class productlist extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(TextilesOrderDetails.this);
            ...
            if(result!=""&& result!=null){
                try {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>
                            (TextilesOrderDetails.this,android.R.layout.select_dialog_item, apparelprolist);
    ...
    public void openvarientbox(String pid,String pname,String pcatge,String pmcatge,String basecost,String status,int postions){
        ...
        if(mainopenstatus.equals("tile")){
            varientdialog = new Dialog(TextilesOrderDetails.this, android.R.style.Theme_Light);
    ...
    private void getMyLocation(){
        if(googleApiClient!=null) {
            if (googleApiClient.isConnected()) {
                int permissionLocation = ContextCompat.checkSelfPermission(TextilesOrderDetails.this,
                            ...
                            switch (status.getStatusCode()) {
                                case LocationSettingsStatusCodes.SUCCESS:
                                    ...
                                    int permissionLocation = ContextCompat
                                            .checkSelfPermission(TextilesOrderDetails.this,
                                                    Manifest.permission.ACCESS_FINE_LOCATION);
                                    if (permissionLocation == PackageManager.PERMISSION_GRANTED) {
                                ...
                                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                    ...
                                    try {
                                        ...
                                        status.startResolutionForResult(TextilesOrderDetails.this,
