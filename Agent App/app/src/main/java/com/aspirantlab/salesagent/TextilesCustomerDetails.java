...
public class  TextilesCustomerDetails extends MainActivity
    ...
    ArrayList<String> eordpronamelist,eordprocatglist,eordpromaincatglist,eordprodidlist,eordsize36,eordsize38,eordsize40,eordsize42,eordsize44,eordsize46,eordsizetype,eordqty,eordtqty,eordsleeve,eordcolor,eordcolimage,eordfit,eordleng,eordvarient;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.dhoticustomer_fragment, null, false);
        ...
        dhagentname = (TextView)findViewById(R.id.dhagentlist);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!String.valueOf(orderdate.getText()).equals("")) {
                    ...
                    Intent intent = new Intent(getBaseContext(), TextilesOrderDetails.class);
                    intent.putExtras(bundle);
                    startActivity(intent);

                }else{
                    Toast.makeText(getApplicationContext(), "Order date is empty", Toast.LENGTH_LONG).show();
                }
    ...
    class Customerlist extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(TextilesCustomerDetails.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if(result!=""&& result!=null){
                try {
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<>(TextilesCustomerDetails.this, android.R.layout.simple_spinner_item, customernamelist);
                                ...
                                for (int i = 0; i < customerIDlist.size(); i++) {
                                    ...
                                    try {
                                        ...
                                        if(cname.equals(str)) {
                                            ...
                                            String dhagent = list.get("dhoti_user_name").toString();
                                            dhagentname.setText(dhagent);
