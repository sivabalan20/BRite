...
public class ApparelsEditOrderDetails   extends MainActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    RelativeLayout relativeLayout,saveproduct,agentconfrim,submit,varientclose,tempsave;
    String MY_PREFS_NAME,User_ID,Order_ID;
    static String Session_ID;
    ArrayList <JSONObject>productlist;
    ArrayList<String> ordwsplist;
    ArrayList<String> ordmrplist,imagevarientlist;
    ...
    ArrayList<String>sleevelist,colorcodelist,coloridlist,fitlist,lenglist,sizelist,sizekeylist,coloraddlist,fullcoloraddlist,selectedcolor,selectedcolimg;
    ...
    public  void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.shirteditorder_fragment, null, false);
        ...
        if (bundle != null) {
            Order_ID = bundle.getString("shirtoid");
        ...
        selectproduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog = new Dialog(ApparelsEditOrderDetails.this,android.R.style.Theme_Light);
                ...
                mainviews.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        PopupMenu popup = new PopupMenu(ApparelsEditOrderDetails.this, mainviews);
    ...
    public void openfilterbox(){
        ...
        brandvalue = "";
        catgevalue = "";
        final Dialog filterdialog = new Dialog(ApparelsEditOrderDetails.this);
        ...
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<>(ApparelsEditOrderDetails.this, android.R.layout.simple_spinner_item, catgefilterlist);
        ...
        ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<>(ApparelsEditOrderDetails.this, android.R.layout.simple_spinner_item, brandfilterlist);
    ...
    class TrouserAdapter extends RecyclerView.Adapter<TrouserAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(final TrouserAdapter.ViewHolder holder, final int position) {
            ...
            if(ordqty.get(position).equals("") ||ordqty.get(position).equals("0")) {
    ...
    public void openvarientbox(String pid,String pname,String pcatge,String pmcatge,String basecost,String status,int postions){
        ...
        if(mainopenstatus.equals("tile")){
            varientdialog = new Dialog(ApparelsEditOrderDetails.this, android.R.style.Theme_Light);
...
//                    mqty.setText(mainmrp);
        ...
        tempsave.setOnClickListener(new View.OnClickListener() {
         ...
         if (gridmainprosta.equals("")) {
                    ...
                    fit1.setTextColor(getResources().getColor(R.color.colorBlack));
                    fit2.setTextColor(getResources().getColor(R.color.colorBlack));
                    fit3.setTextColor(getResources().getColor(R.color.colorBlack));
                    fit4.setTextColor(getResources().getColor(R.color.colorBlack));
                    fit5.setTextColor(getResources().getColor(R.color.colorBlack));
                    slev1.setTextColor(getResources().getColor(R.color.colorBlack));
                    slev2.setTextColor(getResources().getColor(R.color.colorBlack));
                    slev3.setTextColor(getResources().getColor(R.color.colorBlack));
                    slev4.setTextColor(getResources().getColor(R.color.colorBlack));
                    slev5.setTextColor(getResources().getColor(R.color.colorBlack));
                    leng1.setTextColor(getResources().getColor(R.color.colorBlack));
                    leng2.setTextColor(getResources().getColor(R.color.colorBlack));
                    leng3.setTextColor(getResources().getColor(R.color.colorBlack));
                    leng4.setTextColor(getResources().getColor(R.color.colorBlack));
                    leng5.setTextColor(getResources().getColor(R.color.colorBlack));
    ...
    class productlist extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(ApparelsEditOrderDetails.this);
            ...
            if(result!=""&& result!=null){
                try {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>
                            (ApparelsEditOrderDetails.this,android.R.layout.select_dialog_item, apparelprolist);
    ...
    class orderlist extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                params1.put("method", "get_apparel_order_data_withlines");
                params1.put("kwargs", params2);
                    ...
                    for(int i=0; i <ordlist.length();i++) {
                        ...
                        if (!tops.equals("null")) {
                            ...
                            for (int a = 0; a < rm.length(); a++) {
                                ...
                                String s28 = value.get("size_28").toString();
                                String s30 = value.get("size_30").toString();
                                String s32 = value.get("size_32").toString();
                                String s34 = value.get("size_34").toString();
                                ...
                                String s48 = value.get("size_48").toString();
                                ...
                                ordvarient.add("false");
                                int val =Integer.parseInt(s28) +Integer.parseInt(s30) +Integer.parseInt(s32) +Integer.parseInt(s34) + Integer.parseInt(s36) + Integer.parseInt(s38) + Integer.parseInt(s40) + Integer.parseInt(s42) + Integer.parseInt(s44) + Integer.parseInt(s46) + Integer.parseInt(s48) + Integer.parseInt(sqty);
                                toitem = toitem + val;
